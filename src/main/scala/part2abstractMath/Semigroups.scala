...
object Semigroups {
  ...
  def main(args: Array[String]): Unit = {
    println(naturalIntSemigroup.combine(2, 46))                // default combine is addition
    println(naturalStringSemigroup.combine("I love ", "cats")) // default combine is concatenation
    ...
    println(1 |+| 2)
    println("Hello " |+| "there")
    println(Expense(2, 54) |+| Expense(1, 12.8))
